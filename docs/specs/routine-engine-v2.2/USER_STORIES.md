...
> US-28 (active ingredient density insights), and US-29 (phototype-aware SPF adequacy
> recommendation), matching the new `PRD_Spec.md` v1.2 sections 4.2.1–4.2.2 and 5.2.
